...
<!-- seq:N --> markers and reports gaps, duplicates, and counter mismatches.
...
type checkOutput struct {
	...
	Sequences *pipeline.SequenceCheckResult `json:"sequences,omitempty"`
}
...
func runCheckWithCode(cmd *cobra.Command, args []string) int {
	...
	var seqResult *pipeline.SequenceCheckResult
