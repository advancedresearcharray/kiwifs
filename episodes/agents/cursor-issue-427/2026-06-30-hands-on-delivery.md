...
5. Committed on `feat/issue-427-calendar-view-frontmatter-dates`.
...
Calendar view wired into App shell with `/view/calendar` deep links, toolbar toggle, `Mod+Shift+C`, and overlay dismiss. Ready for fork PR to upstream.
